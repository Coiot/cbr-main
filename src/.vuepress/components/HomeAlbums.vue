<template>
  <transition name="fade">
    <div class="album-list">
      ...
      <router-link :to="post.path" tag="div" v-for="(post, index) in albums" v-if="index < 1" :key="post.title" class="post" :style="{ backgroundImage: `url(${post.frontmatter.image})` }" :tabindex="0">
